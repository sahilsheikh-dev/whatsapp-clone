...
import { BsThreeDotsVertical, BsMicFill, BsEmojiSmile } from "react-icons/bs";
...
import WhatsappBg from "../../assets/img/whatsapp-bg.png";
import WhatsappChatBackground from "../../assets/img/whatsapp-chat-bg.png";
  ...
  return (
    <div className="relative">
      <div className="absolute w-[100vw] h-[100vh] bg-[#f0f2f5] flex">
              ...
              <div className=" w-full ">
                ...
                <div className="flex justify-between items-center  px-3 py-3">
                  <div className="flex items-center space-x-3">
                    <img
                      ...
                      src={auth.reqUser?.profile_picture || UserImg}
                      alt=""
                    />
                ...
                <div className="relative flex justify-center items-center bg-white py-4 px-3">
                  <input
                    ...
                    className="border-none outline-none py-2 bg-slate-200 rounded-md w-[100%] pl-9"
                    type="text"
                  ...
                  auth.searchUser?.map((item, index) => (
                    ...
                    >
                      ...
                      <UserChat
                        isChat={false}
                        name={item.full_name}
                        userImg={item.profile_picture || UserImg}
                      />
                    </div>
                  ))}
                  ...
                  chat?.chats?.map((item, index) => (
                    <div onClick={() => handleCurrentChat(item)} key={item.id}>
                      ...
                      {item.is_group ? (
                        <UserChat
                          name={item.chat_name}
                          userImg={item.chat_image || UserImg}
                        />
                      ) : (
                        <UserChat
                          isChat={true}
                          ...
                          userImg={
                            auth.reqUser.id !== item.users[0].id
                              ? item.users[0].profile_picture || UserImg
                              : item.users[1].profile_picture || UserImg
                          }
        ...
        {currentChat && (
          // <div className="w-[70%] bg-slate-400 relative">
          <div
            className="w-[70%] relative"
            style={{ backgroundImage: `url(${WhatsappChatBackground})` }}
          >
            {/* header part */}
                  ...
                  <img
                    ...
                    src={
                      currentChat?.is_group
                        ? currentChat?.chat_image || GroupImg
                        : auth.reqUser?.id !== currentChat?.users[0].id
                        ? currentChat?.users[0].profile_picture || UserImg
                        : currentChat?.users[1].profile_picture || UserImg
                    }
                    alt=""
                  />
                  <p>
